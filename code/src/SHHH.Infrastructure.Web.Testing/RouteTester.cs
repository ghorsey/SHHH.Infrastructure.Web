...
namespace SHHH.Infrastructure.Web.Testing
{
    ...
    public class RouteTester
    {
        ...
        /// <exception cref="System.InvalidOperationException">Could not generate the route data for the rquest: {request url}.  Common pitfalls: a typo in Controller or Action name in the route definition, or incorrectly using Http verbs from System.Web.Mvc instead of System.Web.Http.</exception>
        public RouteTester(HttpConfiguration config, HttpRequestMessage request)
        {
            ...
            {
                var msgFormat = "Could not generate the route data for the rquest: {0}.  Common pitfalls: a typo in Controller or Action name in the route definition, or incorrectly using Http verbs from System.Web.Mvc instead of System.Web.Http.";
